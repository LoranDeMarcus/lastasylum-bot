...
class Config:
    ...
    # Координаты — фолбэк: сначала ищем кнопку шаблоном, тапаем по координате,
    # только если шаблон не нашёлся.
    join_icon_xy: tuple = (986, 1089)        # красная иконка-череп, замер Task 1
